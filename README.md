...
- structured finding candidates and finalized finding model
- normalized finding statuses, severities, confidences, and category mapping
- evaluator-output-to-finding-candidate adapter
- duplicate grouping, similar finding merge, and severity/confidence sorting helpers
- redacted evidence summary helpers and category recommendation templates
- local findings CLI for safe/mock evaluator JSON conversion
- API GET /api/v0/findings/schema endpoint with static Phase 17 contract metadata
...
Run the Phase 17 findings system tests:
