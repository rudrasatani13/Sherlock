...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    app = FastAPI(
        ...
        description="Phase 17 product status for Sherlock. The API includes scan type/limit definitions, queue/worker contracts, and static findings schema metadata. Public scanning, active API persistence, billing, production verification checks, production dashboard API integration, report generation, and production queue deployment are not implemented.",
